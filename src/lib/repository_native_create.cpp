...
{
    boost::filesystem::path index_name = source / m_config.name.file.index;
    boost::filesystem::path checksum_name = source / m_config.name.file.checksum;
    ...
    {
        const std::string src_name = i.second.get_value<std::string>();

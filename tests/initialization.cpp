...
BOOST_AUTO_TEST_CASE(check_initialized) {
  BOOST_CHECK_THROW(bp::check_initialized(empty), bp::initialization_error);
  BOOST_CHECK_THROW(bp::check_initialized<bp::parse_error>(empty),
                    bp::parse_error);
  BOOST_CHECK_THROW(bp::check_initialized<bp::serialize_error>(empty),
                    bp::serialize_error);

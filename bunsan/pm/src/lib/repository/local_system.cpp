...
repository::local_system::local_system(repository &self,
    ...
    : m_self(self), m_config(config), m_resolver(m_config.resolver) {}

bunsan::utility::resolver &repository::local_system::resolver() {
  return m_resolver;
}

bunsan::tempfile repository::local_system::tempdir_for_build() {
...
bunsan::tempfile repository::local_system::small_tempfile() {

...
namespace bunsan{namespace protobuf
{
    ...
    public:
        ...
        template <typename ... Args>
        static void merge(google::protobuf::Message &message,
                          Args &&...args)
        {
            Parser p;
        ...
        template <typename ... Args>
        static void parse(google::protobuf::Message &message,
                          Args &&...args)
        {
            Parser p;
            p.allow_partial(false);
        ...
        static std::string to_string_partial(const google::protobuf::Message &message)
        {
            Serializer s;
            s.allow_partial(true);
